package com.java.javase.java02_javamiddle.char06_Thread.CreateThread;

import java.util.List;

public class PassWordThead extends Thread {
    private boolean found=false;
    private String password;
    private List<String> passwords;
    public PassWordThead(String password,List<String> passwords){
